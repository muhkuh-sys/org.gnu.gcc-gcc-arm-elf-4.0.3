...
# Create an archive.
docker exec ${CONTAINER} /bin/bash -c ". ${WORKDIR}/configuration.sh && cd ${BUILD_DIR_INSTALL_WINDOWS_X86} && zip -9 --recurse-paths ${BUILD_DIR}/${ARTIFACT_NAME}-windows-x86.zip ."
